...
/* ================== API Base URL ================== */
/**
 * Uses deployed backend URL from .env in production.
 *
...
/* ================== Axios instance ================== */
/**
 * Axios instance for trainer task API requests.
...
/* ================== Kanban Columns ================== */
/**
 * These keys must match backend task column values.
 */
const columns = [
    {
        key: "todo",
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {columns.map((col) => {
                    ...
                    return (
                        ...
                        >
                            <h3
                                className={`font-bold mb-4 text-base md:text-lg ${
                                    darkMode
                                        ? "text-gray-200"
                                        : "text-gray-800"
                                }`}
                                ...
                                <AnimatePresence>
                                    {columnTasks.map((task) => (
                                        <Reorder.Item
                                            ...
                                            className={`p-3 rounded-lg shadow-sm cursor-grab transition-colors duration-200 ${
                                                col.color
                                            } ${
                                                darkMode
                                                    ? "text-gray-200"
                            ...
                            {/* Add Task Input only in To Do column */}
                            {col.key === "todo" && (
                                <>
