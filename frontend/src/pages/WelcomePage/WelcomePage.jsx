...
const ScrollAnimation = ({ children, className = "", variants, ...props }) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <section className="relative bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 text-white py-24 px-6 text-center overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <ScrollAnimation variants={slideDown}>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="container mx-auto">
          <ScrollAnimation variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {stats.map((stat, index) => (
              <ScrollAnimation key={index} variants={staggerItem} className="text-center p-6 rounded-xl">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="container mx-auto">
          ...
          <ScrollAnimation variants={staggerContainer} className="grid gap-10 md:grid-cols-3">
            {features.map((feature, index) => (
              <ScrollAnimation key={index} variants={staggerItem}>
                <div className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                  <div
                    className={`w-16 h-16 flex items-center justify-center rounded-2xl text-white ${feature.color} mb-6`}
                  >
                    {feature.icon}
                  </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        <div className="container mx-auto text-center">
          <ScrollAnimation variants={slideUp}>
