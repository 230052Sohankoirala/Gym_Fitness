...
const AddFoodModal = ({ isOpen, onClose, onAdd }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (!formData.food || !formData.calories || !formData.protein || !formData.carbs || !formData.fat) return;
...
const UserNutrients = () => {
    ...
    const [foods, setFoods] = useState([
        { id: 1, food: 'Greek Yogurt with Berries', calories: 180, protein: 15, carbs: 20, fat: 5, time: '10:00 AM', date: 'Oct 12, 2023', meal: 'breakfast' },
