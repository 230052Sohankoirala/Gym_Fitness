...
import { FaArrowLeft, FaClock, FaFire, FaHeartbeat } from "react-icons/fa";
...
const UserWorkoutDetail = () => {
    ...
    return (
        <div className={`${darkMode ? 'bg-gray-900' : 'bg-gray-50'} p-4 md:p-6 min-h-screen transition-colors duration-300`}>
            ...
            <motion.div
                ...
                className={`${darkMode ? 'bg-gray-800 text-gray-200' : 'bg-white text-gray-800'} rounded-2xl shadow-xl overflow-hidden max-w-2xl mx-auto`}
            >
                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className="flex flex-col items-center text-center mb-6">
                        <motion.div
                            ...
                            className="w-28 h-28 mb-5 rounded-2xl flex items-center justify-center text-4xl text-white shadow-lg"
                            style={{ backgroundColor: selectedWorkout.color }}
                        >
                    ...
                    {/* Steps section */}
                    <div className="mb-6">
                        <h3 className={`text-xl font-semibold mb-4 pb-2 border-b ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                            Exercise Steps
                        </h3>
                        <ol className="space-y-3">
                            {selectedWorkout.steps.map((step, index) => (
                                <motion.li
                                    ...
                                    className={`${darkMode ? 'bg-gray-700 hover:bg-gray-600 text-gray-200' : 'bg-gray-50 hover:bg-gray-100 text-gray-800'} flex items-start p-4 rounded-xl transition-colors`}
                                >
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className={`w-full py-4 font-semibold rounded-xl transition-colors shadow-md ${darkMode ? 'text-white' : 'text-white'}`}
                        style={{ backgroundColor: selectedWorkout.color }}
                    >
                        Start This Workout
                    </motion.button>
