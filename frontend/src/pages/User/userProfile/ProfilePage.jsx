...
const ProfilePage = () => {
    ...
    return (
        <div className={`min-h-screen w-full overflow-x-hidden transition-colors duration-200 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
            {/* Header */}
            <motion.div
            ...
            >
                <div className="flex p-4 w-full max-w-2xl mx-auto">
                    ...
                    <h1 className={`text-xl md:text-2xl font-semibold transition-colors duration-200 ${darkMode ? 'text-white' : 'text-gray-800'
                        }`}>
                        Profile
                    </h1>
                </div>
            ...
            <div className="w-full max-w-2xl mx-auto px-4 py-4">
                ...
                >
                    <div className="flex flex-col sm:flex-row items-center">
                        ...
                        <div className="ml-0 sm:ml-4 mt-4 sm:mt-0 text-center sm:text-left">
                            <h2 className={`text-lg sm:text-xl font-semibold transition-colors duration-200 ${darkMode ? 'text-white' : 'text-gray-800'
                                }`}>
                                {userData.name}
                            </h2>
                            ...
                            <p className={`text-sm mt-1 transition-colors duration-200 ${darkMode ? 'text-gray-400' : 'text-gray-500'
                                }`}>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 space-y-4 sm:space-y-0">
                        {[
                            ...
                            >
                                <p className={`text-xl sm:text-2xl font-bold transition-colors duration-200 ${darkMode ? 'text-white' : 'text-gray-800'
                                    }`}>
                                    {stat.value}
                                </p>
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center">
                                    <span className={`transition-colors duration-200 ${darkMode ? 'text-gray-300 mr-3' : 'text-gray-600 mr-3'
                                        }`}>
                                        {section.icon}
                                    </span>
                                    <span className={`font-medium transition-colors duration-200 ${darkMode ? 'text-white' : 'text-gray-800'
                                        }`}>
                                        {section.title}
                                    </span>
                                </div>
                                            ...
                                            {section.items.map((item, itemIndex) => (
                                                ...
                                                >
                                                    <div
                                                        ...
                                                        onClick={() => !item.options && navigate(item.url)}
                                                    >
                                                        {/* Left: icon + name */}
                                                        <div className="flex items-center space-x-3 min-w-0 flex-1">
                                                            <span className={`transition-colors duration-200 ${darkMode ? 'text-gray-300' : 'text-gray-600'
                                                                }`}>
                                                                {item.icon}
                                                            </span>
                                                            <span className={`font-medium transition-colors duration-200 truncate ${darkMode ? 'text-white' : 'text-gray-800'
                                                                }`}>
                                                                {item.name}
                                                            </span>
                                                        </div>

                                                        {/* Right: toggle if options exist */}
                                                        {item.options ? (
                                                            ...
                                                            <ChevronRight size={16} className={darkMode ? 'text-gray-400' : 'text-gray-400 shrink-0'} />
                                                        )}
                                                    </div>
                                                </motion.div>
                                            ))}
                        ...
                        {About && (
                            ...
                            >
                                <p className="text-sm md:text-base leading-relaxed">
                                    Welcome to <span className="font-medium">FitTrack</span> – your personal companion for tracking workouts, monitoring nutrition, and staying motivated on your fitness journey. FitTrack was thoughtfully developed by <span className="font-medium">Alex Johnson</span> to make fitness management simple, intuitive, and effective for everyone.
                                </p>
                                <div
                                ...
                                ></div>
                                <p className="text-sm md:text-base leading-relaxed">
                                    With FitTrack, you can log your workouts, monitor your nutrition intake, track your progress, and achieve your health goals efficiently. Our mission is to provide an easy-to-use platform that motivates users to maintain a consistent fitness routine while giving meaningful insights into their performance and habits. We hope you enjoy your journey with FitTrack!
                                </p>
                            </motion.div>
                        )}
                    </AnimatePresence>
                ...
                <motion.button
                    ...
                    className={`w-full mt-6 p-4 rounded-xl shadow-sm flex items-center justify-center font-medium transition-colors duration-200 ${darkMode
                    ...
                    >
                        ...
                        >
                            <div className="flex justify-between items-center mb-4">
                                <h3 className={`text-lg font-semibold transition-colors duration-200 ${darkMode ? 'text-white' : 'text-gray-800'
                                    }`}>
                                    Confirm Logout
                                </h3>
                                <button
                            ...
                            <p className={`transition-colors duration-200 mb-6 ${darkMode ? 'text-gray-300' : 'text-gray-600'
                                }`}>
                            ...
                            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    onClick={() => setLogoutModal(false)}
                                    className={`flex-1 py-2.5 rounded-lg font-medium transition-colors duration-200 ${darkMode
