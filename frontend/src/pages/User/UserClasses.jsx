...
const UserClasses = () => {
  ...
  const trainerIdOf = (s) =>
    typeof s?.trainer === "string" ? s.trainer : s?.trainer?._id || s?.trainer?.id;
      ...
      <div className="mb-3">
        <div className="flex items-center justify-between text-xs mb-2">
          ...
          <div className="flex gap-2 flex-wrap justify-end">
            {enrolled && <StatusBadge darkMode={darkMode} type="booked" text="Booked" />}
            {!enrolled && paid && <StatusBadge darkMode={darkMode} type="paid" text="Paid" />}
