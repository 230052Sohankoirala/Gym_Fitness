...
const AdminSettings = () => {
  ...
  const card = useMemo(
    () =>
      `rounded-[2rem] border p-5 backdrop-blur-xl transition-all duration-200 hover:shadow-xl ${darkMode
        ? "bg-white/[0.04] border-white/10 shadow-[0_10px_35px_rgba(0,0,0,0.35)]"
        : "bg-white/85 border-slate-200/80 shadow-[0_10px_30px_rgba(15,23,42,0.08)]"
      }`,
    [darkMode]
  );
  ...
  const input =
    `w-full px-4 py-3 rounded-2xl outline-none transition-all duration-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-400 ` +
    (darkMode
